                        ...
                        <form action="/action">
                            <div class ="d-flex align-items-center ">
                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Username" value="Admin123"> 
                                        </div>                                                       
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-3"><label for="profil">Password:</label></div> 
                                        <div class="col-md-4 mt-2"><input type="password" class="form-control" placeholder="password" value="admin123"></div>                                                      
                                    </div>   
